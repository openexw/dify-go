...
func (x *PreviewRequest) GetAsAttachment() bool {
	if x != nil {
...
func (x *PreviewResponse) GetContent() []byte {
	if x != nil {
		return x.Content
	}
	return nil
...
const file_files_files_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\a \x01(\rR\tcreatedAt\"N\n" +
	"\x0ePreviewRequest\x12\x17\n" +
	"\afile_id\x18\x01 \x01(\tR\x06fileId\x12#\n" +
	"\ras_attachment\x18\x02 \x01(\bR\fasAttachment\"+\n" +
	"\x0fPreviewResponse\x12\x18\n" +
	"\acontent\x18\x01 \x01(\fR\acontentB\x93\x01\n" +
	"\x0fcom.workflow.v1B\n" +
...
var file_files_files_proto_goTypes = []any{
	...
	(*PreviewRequest)(nil),  // 2: workflow.v1.PreviewRequest
	(*PreviewResponse)(nil), // 3: workflow.v1.PreviewResponse
}
